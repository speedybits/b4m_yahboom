...
def generate_launch_description():
    # Use direct paths instead of get_package_share_directory
    b4m_yahboom_dir = '/home/yahboom/b4m_yahboom'
    package_path = os.path.join(b4m_yahboom_dir, 'yahboomcar_nav')
    nav2_bringup_dir = '/opt/ros/humble/share/nav2_bringup'
    yahboom_description_dir = os.path.join(b4m_yahboom_dir, 'yahboomcar_description')
    ...
    urdf_model_path = os.path.join(yahboom_description_dir, 'urdf', 'yahboomcar_robot2.urdf')
    ...
    return LaunchDescription([
        ...
        # TF static transform publisher for laser scanner
        Node(
            package='tf2_ros',
