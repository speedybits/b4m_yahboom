#!/usr/bin/env python3
# test_square_corners_classic.py - Test that verifies robot reaches each corner of 1m square in Gazebo Classic
...
def test_square_corners():
    """Test that robot reaches each corner of a 1-meter square in Gazebo Classic"""
    ...
    try:
        ...
        time.sleep(15)  # Give Gazebo Classic more time to start
